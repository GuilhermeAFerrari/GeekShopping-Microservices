using AutoMapper;
using GeekShopping.Coupon.API.Configure;
using GeekShopping.Coupon.API.Models.Context;
using GeekShopping.Coupon.API.Repositories;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "GeekShopping Coupon API", Version = "v1" });
    c.EnableAnnotations();
